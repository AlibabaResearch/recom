...
#include "string_to_hash_bucket_fast_op_infer_fn.h"
#include "tensorflow_addons/symbolic_shape/symbolic_shape_fn.h"

namespace tensorflow {
namespace feature_opt {

bool StringToHashBucketFastOpInferFn::InferStringToHashBucketFastShape(
...
REGISTER_SYMBOLIC_SHAPE_FN("StringToHashBucketFast",
                           StringToHashBucketFastOpInferFn);

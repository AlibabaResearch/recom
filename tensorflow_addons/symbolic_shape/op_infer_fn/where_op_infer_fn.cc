...
bool WhereOpInferFn::InferWhereShape(
  ...
  context->SetShape(node->name(), {n, input_shape.size()});

  return true;
}

REGISTER_SYMBOLIC_SHAPE_FN("Where", WhereOpInferFn);
